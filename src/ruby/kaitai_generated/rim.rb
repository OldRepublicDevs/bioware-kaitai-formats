...
class Rim < Kaitai::Struct::Struct
  ...
  def _read
    ...
    @extended_header = RimExtendedHeader.new(@_io, self, @_root)
  ...
  class RimExtendedHeader < Kaitai::Struct::Struct
    def initialize(_io, _parent = nil, _root = nil)
      super(_io, _parent, _root)
      _read
    end
    ...
    def _read
      @reserved_padding = (@_io.read_bytes(100)).force_encoding("ASCII").encode('UTF-8')
      self
    end
