...
class Lyt < Kaitai::Struct::Struct
  ...
  def _read
    @raw_content = (@_io.read_bytes_full).force_encoding("ASCII").encode('UTF-8')
    self
  end
  ...
  class ArtplaceableEntry < Kaitai::Struct::Struct
    def initialize(_io, _parent = nil, _root = nil)
  ...
  class DoorhookEntryPykotor < Kaitai::Struct::Struct
    def initialize(_io, _parent = nil, _root = nil)
      super(_io, _parent, _root)
      _read
    end
  ...
  class DoorhookEntryXoreos < Kaitai::Struct::Struct
    def initialize(_io, _parent = nil, _root = nil)
      super(_io, _parent, _root)
      _read
    end
  ...
  # 
  # Example: "M17mg_MGO01 103.309 3691.61 0.0"
  class ObstacleEntry < Kaitai::Struct::Struct
    def initialize(_io, _parent = nil, _root = nil)
      super(_io, _parent, _root)
      _read
    end
  ...
  # 
  # Example: "M17mg_01a 100.0 100.0 0.0"
  class RoomEntry < Kaitai::Struct::Struct
    def initialize(_io, _parent = nil, _root = nil)
      super(_io, _parent, _root)
      _read
    end
  ...
  # 
  # Example: "M17mg_MGT01 0.0 0.0 0.0"
  class TrackEntry < Kaitai::Struct::Struct
    def initialize(_io, _parent = nil, _root = nil)
      super(_io, _parent, _root)
      _read
    end
  ...
  class WalkmeshRoomEntry < Kaitai::Struct::Struct
    def initialize(_io, _parent = nil, _root = nil)
      super(_io, _parent, _root)
      _read
    end
