...
pub struct Utp {
    pub _root: SharedType<Utp>,
    pub _parent: SharedType<Utp>,
...
impl Utp {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "UTP ".to_string()) as bool;
