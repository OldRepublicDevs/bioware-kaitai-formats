...
pub struct Git {
    pub _root: SharedType<Git>,
    pub _parent: SharedType<Git>,
...
impl Git {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "GIT ".to_string()) as bool;
