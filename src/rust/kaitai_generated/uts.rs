...
pub struct Uts {
    pub _root: SharedType<Uts>,
    pub _parent: SharedType<Uts>,
...
impl Uts {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "UTS ".to_string()) as bool;
