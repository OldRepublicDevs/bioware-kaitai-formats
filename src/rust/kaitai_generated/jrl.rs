...
pub struct Jrl {
    pub _root: SharedType<Jrl>,
    pub _parent: SharedType<Jrl>,
...
impl Jrl {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "JRL ".to_string()) as bool;
