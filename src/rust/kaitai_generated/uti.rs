...
pub struct Uti {
    pub _root: SharedType<Uti>,
    pub _parent: SharedType<Uti>,
...
impl Uti {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "UTI ".to_string()) as bool;
