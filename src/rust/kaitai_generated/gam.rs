...
pub struct Gam {
    pub _root: SharedType<Gam>,
    pub _parent: SharedType<Gam>,
...
impl Gam {
    ...
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "GAM ".to_string()) as bool;
