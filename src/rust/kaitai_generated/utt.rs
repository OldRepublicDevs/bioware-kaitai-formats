...
pub struct Utt {
    pub _root: SharedType<Utt>,
    pub _parent: SharedType<Utt>,
...
impl Utt {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "UTT ".to_string()) as bool;
