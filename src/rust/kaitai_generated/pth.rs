...
pub struct Pth {
    pub _root: SharedType<Pth>,
    pub _parent: SharedType<Pth>,
...
impl Pth {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "PTH ".to_string()) as bool;
