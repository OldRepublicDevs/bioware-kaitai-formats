...
pub struct Dlg {
    pub _root: SharedType<Dlg>,
    pub _parent: SharedType<Dlg>,
...
impl Dlg {
    ...
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "DLG ".to_string()) as bool;
