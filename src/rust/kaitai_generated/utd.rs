...
pub struct Utd {
    pub _root: SharedType<Utd>,
    pub _parent: SharedType<Utd>,
...
impl Utd {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "UTD ".to_string()) as bool;
