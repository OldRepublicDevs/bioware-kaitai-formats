...
pub struct Ute {
    pub _root: SharedType<Ute>,
    pub _parent: SharedType<Ute>,
...
impl Ute {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "UTE ".to_string()) as bool;
