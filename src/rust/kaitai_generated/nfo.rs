...
pub struct Nfo {
    pub _root: SharedType<Nfo>,
    pub _parent: SharedType<Nfo>,
...
impl Nfo {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "NFO ".to_string()) as bool;
