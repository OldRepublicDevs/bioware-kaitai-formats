...
pub struct Gvt {
    pub _root: SharedType<Gvt>,
    pub _parent: SharedType<Gvt>,
...
impl Gvt {
    pub fn file_type_valid(
        ...
        *self.file_type_valid.borrow_mut() = (*self.gff_data().header().file_type() == "GVT ".to_string()) as bool;
