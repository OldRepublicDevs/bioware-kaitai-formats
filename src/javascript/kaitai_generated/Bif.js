...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.Bif || (root.Bif = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (Bif_, KaitaiStream) {
/**
...
var Bif = (function() {
  Bif.XoreosFileTypeId = Object.freeze({
    NONE: -1,
    RES: 0,
    BMP: 1,
    MVE: 2,
  ...
  var VarResourceEntry = Bif.VarResourceEntry = (function() {
     ...
     */
    Object.defineProperty(VarResourceEntry.prototype, 'data', {
      get: function() {
        if (this._m_data !== undefined)
          return this._m_data;
        var _pos = this._io.pos;
        this._io.seek(this.offset);
        this._m_data = this._io.readBytes(this.fileSize);
        this._io.seek(_pos);
        return this._m_data;
      }
    });
