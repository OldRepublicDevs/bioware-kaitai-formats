...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.Key || (root.Key = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (Key_, KaitaiStream) {
/**
...
var Key = (function() {
  Key.XoreosFileTypeId = Object.freeze({
    NONE: -1,
    RES: 0,
    BMP: 1,
    MVE: 2,
  ...
  var FileEntry = Key.FileEntry = (function() {
    ...
    Object.defineProperty(FileEntry.prototype, 'filename', {
      get: function() {
        ...
        this._io.seek((this._root.fileTableOffset + this._root.bifCount * 12) + this.filenameOffset);
