...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.Lyt || (root.Lyt = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (Lyt_, KaitaiStream) {
/**
...
var Lyt = (function() {
  function Lyt(_io, _parent, _root) {
    this._io = _io;
  ...
  Lyt.prototype._read = function() {
    this.rawContent = KaitaiStream.bytesToStr(this._io.readBytesFull(), "ASCII");
  }
  ...
  var ArtplaceableEntry = Lyt.ArtplaceableEntry = (function() {
    function ArtplaceableEntry(_io, _parent, _root) {
      this._io = _io;
      this._parent = _parent;
      this._root = _root;
    ...
    ArtplaceableEntry.prototype._read = function() {
    }

    return ArtplaceableEntry;
  })();
  ...
  var DoorhookEntryPykotor = Lyt.DoorhookEntryPykotor = (function() {
    function DoorhookEntryPykotor(_io, _parent, _root) {
      this._io = _io;
      this._parent = _parent;
      this._root = _root;
    ...
    DoorhookEntryPykotor.prototype._read = function() {
    }

    return DoorhookEntryPykotor;
  })();
  ...
  var DoorhookEntryXoreos = Lyt.DoorhookEntryXoreos = (function() {
    function DoorhookEntryXoreos(_io, _parent, _root) {
      this._io = _io;
      this._parent = _parent;
      this._root = _root;
    ...
    DoorhookEntryXoreos.prototype._read = function() {
    }

    return DoorhookEntryXoreos;
  })();
  ...
  var ObstacleEntry = Lyt.ObstacleEntry = (function() {
    function ObstacleEntry(_io, _parent, _root) {
      this._io = _io;
      this._parent = _parent;
      this._root = _root;
    ...
    ObstacleEntry.prototype._read = function() {
    }
  ...
  var RoomEntry = Lyt.RoomEntry = (function() {
    function RoomEntry(_io, _parent, _root) {
      this._io = _io;
      this._parent = _parent;
      this._root = _root;
    ...
    RoomEntry.prototype._read = function() {
    }
  ...
  var TrackEntry = Lyt.TrackEntry = (function() {
    function TrackEntry(_io, _parent, _root) {
      this._io = _io;
      this._parent = _parent;
      this._root = _root;
    ...
    TrackEntry.prototype._read = function() {
    }
  ...
  var WalkmeshRoomEntry = Lyt.WalkmeshRoomEntry = (function() {
    function WalkmeshRoomEntry(_io, _parent, _root) {
      this._io = _io;
      this._parent = _parent;
      this._root = _root;
    ...
    WalkmeshRoomEntry.prototype._read = function() {
    }

    return WalkmeshRoomEntry;
  })();
