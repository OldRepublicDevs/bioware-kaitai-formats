"""
Test suite for BioWare UTM (Store/Merchant Template) File Format.
Auto-generated from utm.ksy to match PyKotor test patterns.
"""

import unittest
from pathlib import Path

from pykotor.resource.generics.utm import read_utm, write_utm, UTM
from pykotor.resource.type import ResourceType


class TestUTM(unittest.TestCase):
    """Test UTM read/write operations.
    ...
    def test_io_construct(self):
        """Test constructing UTM from binary data."""
        # TODO: Implement based on PyKotor's test_utm.py
