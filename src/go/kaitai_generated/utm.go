...
func (this Utm) IO_() *kaitai.Stream {
	return this._io
}

func (this *Utm) Read(io *kaitai.Stream, parent kaitai.Struct, root *Utm) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
...
func (this *Utm) FileTypeValid() (v bool, err error) {
	if (this._f_fileTypeValid) {
		return this.fileTypeValid, nil
	}
	this._f_fileTypeValid = true
	this.fileTypeValid = bool(this.GffData.Header.FileType == "UTM ")
	return this.fileTypeValid, nil
}
func (this *Utm) VersionValid() (v bool, err error) {
