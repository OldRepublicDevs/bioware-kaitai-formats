...
func (this Lyt) IO_() *kaitai.Stream {
	return this._io
}

func (this *Lyt) Read(io *kaitai.Stream, parent kaitai.Struct, root *Lyt) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
 ...
 */
type Lyt_ArtplaceableEntry struct {
	_io *kaitai.Stream
	_root *Lyt
	_parent kaitai.Struct
}
func NewLyt_ArtplaceableEntry() *Lyt_ArtplaceableEntry {
	return &Lyt_ArtplaceableEntry{
	}
}

func (this Lyt_ArtplaceableEntry) IO_() *kaitai.Stream {
	return this._io
}

func (this *Lyt_ArtplaceableEntry) Read(io *kaitai.Stream, parent kaitai.Struct, root *Lyt) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
 ...
 */
type Lyt_DoorhookEntryPykotor struct {
	_io *kaitai.Stream
	_root *Lyt
	_parent kaitai.Struct
}
func NewLyt_DoorhookEntryPykotor() *Lyt_DoorhookEntryPykotor {
	return &Lyt_DoorhookEntryPykotor{
	}
}

func (this Lyt_DoorhookEntryPykotor) IO_() *kaitai.Stream {
	return this._io
}

func (this *Lyt_DoorhookEntryPykotor) Read(io *kaitai.Stream, parent kaitai.Struct, root *Lyt) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
 ...
 */
type Lyt_DoorhookEntryXoreos struct {
	_io *kaitai.Stream
	_root *Lyt
	_parent kaitai.Struct
}
func NewLyt_DoorhookEntryXoreos() *Lyt_DoorhookEntryXoreos {
	return &Lyt_DoorhookEntryXoreos{
	}
}

func (this Lyt_DoorhookEntryXoreos) IO_() *kaitai.Stream {
	return this._io
}

func (this *Lyt_DoorhookEntryXoreos) Read(io *kaitai.Stream, parent kaitai.Struct, root *Lyt) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
 ...
 * Example: "M17mg_MGO01 103.309 3691.61 0.0"
 */
type Lyt_ObstacleEntry struct {
	_io *kaitai.Stream
	_root *Lyt
	_parent kaitai.Struct
}
func NewLyt_ObstacleEntry() *Lyt_ObstacleEntry {
	return &Lyt_ObstacleEntry{
	}
}

func (this Lyt_ObstacleEntry) IO_() *kaitai.Stream {
	return this._io
}

func (this *Lyt_ObstacleEntry) Read(io *kaitai.Stream, parent kaitai.Struct, root *Lyt) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
 ...
 * Example: "M17mg_01a 100.0 100.0 0.0"
 */
type Lyt_RoomEntry struct {
	_io *kaitai.Stream
	_root *Lyt
	_parent kaitai.Struct
}
func NewLyt_RoomEntry() *Lyt_RoomEntry {
	return &Lyt_RoomEntry{
	}
}

func (this Lyt_RoomEntry) IO_() *kaitai.Stream {
	return this._io
}

func (this *Lyt_RoomEntry) Read(io *kaitai.Stream, parent kaitai.Struct, root *Lyt) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
 ...
 * Example: "M17mg_MGT01 0.0 0.0 0.0"
 */
type Lyt_TrackEntry struct {
	_io *kaitai.Stream
	_root *Lyt
	_parent kaitai.Struct
}
func NewLyt_TrackEntry() *Lyt_TrackEntry {
	return &Lyt_TrackEntry{
	}
}

func (this Lyt_TrackEntry) IO_() *kaitai.Stream {
	return this._io
}

func (this *Lyt_TrackEntry) Read(io *kaitai.Stream, parent kaitai.Struct, root *Lyt) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
 ...
 */
type Lyt_WalkmeshRoomEntry struct {
	_io *kaitai.Stream
	_root *Lyt
	_parent kaitai.Struct
}
func NewLyt_WalkmeshRoomEntry() *Lyt_WalkmeshRoomEntry {
	return &Lyt_WalkmeshRoomEntry{
	}
}

func (this Lyt_WalkmeshRoomEntry) IO_() *kaitai.Stream {
	return this._io
}

func (this *Lyt_WalkmeshRoomEntry) Read(io *kaitai.Stream, parent kaitai.Struct, root *Lyt) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
