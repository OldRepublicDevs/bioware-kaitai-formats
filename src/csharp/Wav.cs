...
namespace Kaitai
{
    ...
    public partial class Wav : KaitaiStruct
    {
        ...
        public partial class DataChunkBody : KaitaiStruct
        {
            ...
            private void _read()
            {
                _data = System.Text.Encoding.GetEncoding("ASCII").GetString(m_io.ReadBytes(M_Parent.Size));
            }
        ...
        public partial class FormatChunkBody : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (M_Parent.Size > 16) {
                    _extraFormatBytes = System.Text.Encoding.GetEncoding("ASCII").GetString(m_io.ReadBytes(M_Parent.Size - 16));
                }
            }
            ...
            private string _extraFormatBytes;
            private Wav m_root;
            private Wav.Chunk m_parent;
            ...
            /// Reference: vendor/xoreos/src/sound/decoders/wave.cpp:66
            /// </summary>
            public string ExtraFormatBytes { get { return _extraFormatBytes; } }
            public Wav M_Root { get { return m_root; } }
            public Wav.Chunk M_Parent { get { return m_parent; } }
        }
