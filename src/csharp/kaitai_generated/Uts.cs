...
namespace Kaitai
{
    ...
    /// </summary>
    public partial class Uts : KaitaiStruct
    {
        public static Uts FromFile(string fileName)
        {
            return new Uts(new KaitaiStream(fileName));
        }

        public Uts(KaitaiStream p__io, KaitaiStruct p__parent = null, Uts p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
        ...
        public bool FileTypeValid
        {
            get
            {
                ...
                _fileTypeValid = (bool) (GffData.Header.FileType == "UTS ");
                return _fileTypeValid;
            }
        }
        ...
        public Uts M_Root { get { return m_root; } }
