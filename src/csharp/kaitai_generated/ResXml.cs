...
namespace Kaitai
{
    ...
    /// </summary>
    public partial class ResXml : KaitaiStruct
    {
        public static ResXml FromFile(string fileName)
        {
            return new ResXml(new KaitaiStream(fileName));
        }

        public ResXml(KaitaiStream p__io, KaitaiStruct p__parent = null, ResXml p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public ResXml M_Root { get { return m_root; } }
