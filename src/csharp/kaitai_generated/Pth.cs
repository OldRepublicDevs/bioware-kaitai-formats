...
namespace Kaitai
{
    ...
    /// </summary>
    public partial class Pth : KaitaiStruct
    {
        public static Pth FromFile(string fileName)
        {
            return new Pth(new KaitaiStream(fileName));
        }

        public Pth(KaitaiStream p__io, KaitaiStruct p__parent = null, Pth p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
        ...
        public bool FileTypeValid
        {
            get
            {
                ...
                _fileTypeValid = (bool) (GffData.Header.FileType == "PTH ");
                return _fileTypeValid;
            }
        }
        ...
        public Pth M_Root { get { return m_root; } }
