...
namespace Kaitai
{
    ...
    /// </summary>
    public partial class Utm : KaitaiStruct
    {
        public static Utm FromFile(string fileName)
        {
            return new Utm(new KaitaiStream(fileName));
        }

        public Utm(KaitaiStream p__io, KaitaiStruct p__parent = null, Utm p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
        ...
        public bool FileTypeValid
        {
            get
            {
                ...
                _fileTypeValid = (bool) (GffData.Header.FileType == "UTM ");
                return _fileTypeValid;
            }
        }
        ...
        public Utm M_Root { get { return m_root; } }
