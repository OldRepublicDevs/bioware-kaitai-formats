...
class bif__xoreos_file_type_id(enum.IntEnum):
	none = -1
	res = 0
	bmp = 1
	mve = 2
...
bif__var_resource_entry = Struct(
	...
	'offset' / Int32ul,
	'file_size' / Int32ul,
	'resource_type' / Enum(Int32ul, bif__xoreos_file_type_id),
	'data' / Pointer(this.offset, FixedSized(this.file_size, GreedyBytes)),
)
