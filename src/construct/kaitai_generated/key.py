...
class key__xoreos_file_type_id(enum.IntEnum):
	none = -1
	res = 0
	bmp = 1
	mve = 2
...
key__file_entry = Struct(
	...
	'drives' / Int16ul,
	'filename' / Pointer((this._root.file_table_offset + this._root.bif_count * 12) + this.filename_offset, FixedSized(this.filename_size, GreedyString(encoding='ASCII'))),
)
...
key__key_entry = Struct(
	...
	'resource_type' / Enum(Int16ul, key__xoreos_file_type_id),
	'resource_id' / Int32ul,
)
