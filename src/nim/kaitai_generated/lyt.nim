...
type
  Lyt* = ref object of KaitaiStruct
    `rawContent`*: string
    `parent`*: KaitaiStruct
  Lyt_ArtplaceableEntry* = ref object of KaitaiStruct
    `parent`*: KaitaiStruct
  Lyt_DoorhookEntryPykotor* = ref object of KaitaiStruct
    `parent`*: KaitaiStruct
  Lyt_DoorhookEntryXoreos* = ref object of KaitaiStruct
    `parent`*: KaitaiStruct
  Lyt_ObstacleEntry* = ref object of KaitaiStruct
    `parent`*: KaitaiStruct
  Lyt_RoomEntry* = ref object of KaitaiStruct
    `parent`*: KaitaiStruct
  Lyt_TrackEntry* = ref object of KaitaiStruct
    `parent`*: KaitaiStruct
  Lyt_WalkmeshRoomEntry* = ref object of KaitaiStruct
    `parent`*: KaitaiStruct

proc read*(_: typedesc[Lyt], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt
proc read*(_: typedesc[Lyt_ArtplaceableEntry], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_ArtplaceableEntry
proc read*(_: typedesc[Lyt_DoorhookEntryPykotor], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_DoorhookEntryPykotor
proc read*(_: typedesc[Lyt_DoorhookEntryXoreos], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_DoorhookEntryXoreos
proc read*(_: typedesc[Lyt_ObstacleEntry], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_ObstacleEntry
proc read*(_: typedesc[Lyt_RoomEntry], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_RoomEntry
proc read*(_: typedesc[Lyt_TrackEntry], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_TrackEntry
proc read*(_: typedesc[Lyt_WalkmeshRoomEntry], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_WalkmeshRoomEntry
...
proc read*(_: typedesc[Lyt], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt =
  ...
  this = new(Lyt)
  let root = if root == nil: cast[Lyt](this) else: cast[Lyt](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[Lyt], filename: string): Lyt =
  Lyt.read(newKaitaiFileStream(filename), nil, nil)
...
proc read*(_: typedesc[Lyt_ArtplaceableEntry], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_ArtplaceableEntry =
  template this: untyped = result
  this = new(Lyt_ArtplaceableEntry)
  let root = if root == nil: cast[Lyt](this) else: cast[Lyt](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[Lyt_ArtplaceableEntry], filename: string): Lyt_ArtplaceableEntry =
  Lyt_ArtplaceableEntry.read(newKaitaiFileStream(filename), nil, nil)
...
proc read*(_: typedesc[Lyt_DoorhookEntryPykotor], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_DoorhookEntryPykotor =
  template this: untyped = result
  this = new(Lyt_DoorhookEntryPykotor)
  let root = if root == nil: cast[Lyt](this) else: cast[Lyt](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[Lyt_DoorhookEntryPykotor], filename: string): Lyt_DoorhookEntryPykotor =
  Lyt_DoorhookEntryPykotor.read(newKaitaiFileStream(filename), nil, nil)
...
proc read*(_: typedesc[Lyt_DoorhookEntryXoreos], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_DoorhookEntryXoreos =
  template this: untyped = result
  this = new(Lyt_DoorhookEntryXoreos)
  let root = if root == nil: cast[Lyt](this) else: cast[Lyt](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[Lyt_DoorhookEntryXoreos], filename: string): Lyt_DoorhookEntryXoreos =
  Lyt_DoorhookEntryXoreos.read(newKaitaiFileStream(filename), nil, nil)
...
proc fromFile*(_: typedesc[Lyt_ObstacleEntry], filename: string): Lyt_ObstacleEntry =
  Lyt_ObstacleEntry.read(newKaitaiFileStream(filename), nil, nil)
...
proc fromFile*(_: typedesc[Lyt_RoomEntry], filename: string): Lyt_RoomEntry =
  Lyt_RoomEntry.read(newKaitaiFileStream(filename), nil, nil)
...
proc fromFile*(_: typedesc[Lyt_TrackEntry], filename: string): Lyt_TrackEntry =
  Lyt_TrackEntry.read(newKaitaiFileStream(filename), nil, nil)
...
proc read*(_: typedesc[Lyt_WalkmeshRoomEntry], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Lyt_WalkmeshRoomEntry =
  template this: untyped = result
  this = new(Lyt_WalkmeshRoomEntry)
  let root = if root == nil: cast[Lyt](this) else: cast[Lyt](root)
  this.io = io
  this.root = root
  this.parent = parent
...
proc fromFile*(_: typedesc[Lyt_WalkmeshRoomEntry], filename: string): Lyt_WalkmeshRoomEntry =
  Lyt_WalkmeshRoomEntry.read(newKaitaiFileStream(filename), nil, nil)
