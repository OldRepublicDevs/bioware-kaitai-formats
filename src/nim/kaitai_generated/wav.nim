...
Reference: https://github.com/OldRepublicDevs/PyKotor/wiki/WAV-File-Format.md
  ...
  let audioFormatExpr = this.io.readU2le()
...
proc isImaAdpcm(this: Wav_FormatChunkBody): bool = 
  ...
  let isImaAdpcmInstExpr = bool(this.audioFormat == 17)
...
proc isMp3(this: Wav_FormatChunkBody): bool = 
  ...
  let isMp3InstExpr = bool(this.audioFormat == 85)
...
proc isPcm(this: Wav_FormatChunkBody): bool = 
  ...
  let isPcmInstExpr = bool(this.audioFormat == 1)
