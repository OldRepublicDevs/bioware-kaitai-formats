 ...
 */
public class Vis extends KaitaiStruct {
    public static Vis fromFile(String fileName) throws IOException {
        return new Vis(new ByteBufferKaitaiStream(fileName));
    }

    public Vis(KaitaiStream _io) {
        this(_io, null, null);
    }

    public Vis(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public Vis(KaitaiStream _io, KaitaiStruct _parent, Vis _root) {
        super(_io);
