 ...
 */
public class Lyt extends KaitaiStruct {
    public static Lyt fromFile(String fileName) throws IOException {
        return new Lyt(new ByteBufferKaitaiStream(fileName));
    }

    public Lyt(KaitaiStream _io) {
        this(_io, null, null);
    }

    public Lyt(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public Lyt(KaitaiStream _io, KaitaiStruct _parent, Lyt _root) {
        super(_io);
    ...
    private void _read() {
        this.rawContent = new String(this._io.readBytesFull(), StandardCharsets.US_ASCII);
    }
     ...
     */
    public static class ArtplaceableEntry extends KaitaiStruct {
        public static ArtplaceableEntry fromFile(String fileName) throws IOException {
            return new ArtplaceableEntry(new ByteBufferKaitaiStream(fileName));
        }

        public ArtplaceableEntry(KaitaiStream _io) {
            this(_io, null, null);
        }

        public ArtplaceableEntry(KaitaiStream _io, KaitaiStruct _parent) {
            this(_io, _parent, null);
        }

        public ArtplaceableEntry(KaitaiStream _io, KaitaiStruct _parent, Lyt _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
     ...
     */
    public static class DoorhookEntryPykotor extends KaitaiStruct {
        public static DoorhookEntryPykotor fromFile(String fileName) throws IOException {
            return new DoorhookEntryPykotor(new ByteBufferKaitaiStream(fileName));
        }

        public DoorhookEntryPykotor(KaitaiStream _io) {
            this(_io, null, null);
        }

        public DoorhookEntryPykotor(KaitaiStream _io, KaitaiStruct _parent) {
            this(_io, _parent, null);
        }

        public DoorhookEntryPykotor(KaitaiStream _io, KaitaiStruct _parent, Lyt _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
     ...
     */
    public static class DoorhookEntryXoreos extends KaitaiStruct {
        public static DoorhookEntryXoreos fromFile(String fileName) throws IOException {
            return new DoorhookEntryXoreos(new ByteBufferKaitaiStream(fileName));
        }

        public DoorhookEntryXoreos(KaitaiStream _io) {
            this(_io, null, null);
        }

        public DoorhookEntryXoreos(KaitaiStream _io, KaitaiStruct _parent) {
            this(_io, _parent, null);
        }

        public DoorhookEntryXoreos(KaitaiStream _io, KaitaiStruct _parent, Lyt _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
     ...
     * Example: "M17mg_MGO01 103.309 3691.61 0.0"
     */
    public static class ObstacleEntry extends KaitaiStruct {
        public static ObstacleEntry fromFile(String fileName) throws IOException {
            return new ObstacleEntry(new ByteBufferKaitaiStream(fileName));
        }

        public ObstacleEntry(KaitaiStream _io) {
            this(_io, null, null);
        }

        public ObstacleEntry(KaitaiStream _io, KaitaiStruct _parent) {
            this(_io, _parent, null);
        }

        public ObstacleEntry(KaitaiStream _io, KaitaiStruct _parent, Lyt _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
     ...
     * Example: "M17mg_01a 100.0 100.0 0.0"
     */
    public static class RoomEntry extends KaitaiStruct {
        public static RoomEntry fromFile(String fileName) throws IOException {
            return new RoomEntry(new ByteBufferKaitaiStream(fileName));
        }

        public RoomEntry(KaitaiStream _io) {
            this(_io, null, null);
        }

        public RoomEntry(KaitaiStream _io, KaitaiStruct _parent) {
            this(_io, _parent, null);
        }

        public RoomEntry(KaitaiStream _io, KaitaiStruct _parent, Lyt _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
     ...
     * Example: "M17mg_MGT01 0.0 0.0 0.0"
     */
    public static class TrackEntry extends KaitaiStruct {
        public static TrackEntry fromFile(String fileName) throws IOException {
            return new TrackEntry(new ByteBufferKaitaiStream(fileName));
        }

        public TrackEntry(KaitaiStream _io) {
            this(_io, null, null);
        }

        public TrackEntry(KaitaiStream _io, KaitaiStruct _parent) {
            this(_io, _parent, null);
        }

        public TrackEntry(KaitaiStream _io, KaitaiStruct _parent, Lyt _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
     ...
     */
    public static class WalkmeshRoomEntry extends KaitaiStruct {
        public static WalkmeshRoomEntry fromFile(String fileName) throws IOException {
            return new WalkmeshRoomEntry(new ByteBufferKaitaiStream(fileName));
        }

        public WalkmeshRoomEntry(KaitaiStream _io) {
            this(_io, null, null);
        }

        public WalkmeshRoomEntry(KaitaiStream _io, KaitaiStruct _parent) {
            this(_io, _parent, null);
        }

        public WalkmeshRoomEntry(KaitaiStream _io, KaitaiStruct _parent, Lyt _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
