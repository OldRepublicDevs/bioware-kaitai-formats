...
Bif.XoreosFileTypeId = enum.Enum {
  none = -1,
  res = 0,
  bmp = 1,
  mve = 2,
...
function Bif.VarResourceEntry:_read()
  ...
  self.resource_type = Bif.XoreosFileTypeId(self._io:read_u4le())
end

-- 
-- Raw binary data for the resource (read at specified offset).
Bif.VarResourceEntry.property.data = {}
function Bif.VarResourceEntry.property.data:get()
