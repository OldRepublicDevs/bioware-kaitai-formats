...
Lyt = class.class(KaitaiStruct)

function Lyt:_init(io, parent, root)
...
function Lyt:_read()
  self.raw_content = str_decode.decode(self._io:read_bytes_full(), "ASCII")
end
...
Lyt.ArtplaceableEntry = class.class(KaitaiStruct)

function Lyt.ArtplaceableEntry:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root
  self:_read()
...
function Lyt.ArtplaceableEntry:_read()
end
...
Lyt.DoorhookEntryPykotor = class.class(KaitaiStruct)

function Lyt.DoorhookEntryPykotor:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root
  self:_read()
...
function Lyt.DoorhookEntryPykotor:_read()
end
...
Lyt.DoorhookEntryXoreos = class.class(KaitaiStruct)

function Lyt.DoorhookEntryXoreos:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root
  self:_read()
...
function Lyt.DoorhookEntryXoreos:_read()
end
...
-- 
-- Example: "M17mg_MGO01 103.309 3691.61 0.0"
Lyt.ObstacleEntry = class.class(KaitaiStruct)

function Lyt.ObstacleEntry:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root
  self:_read()
...
function Lyt.ObstacleEntry:_read()
end
...
-- 
-- Example: "M17mg_01a 100.0 100.0 0.0"
Lyt.RoomEntry = class.class(KaitaiStruct)

function Lyt.RoomEntry:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root
  self:_read()
...
-- 
-- Example: "M17mg_MGT01 0.0 0.0 0.0"
Lyt.TrackEntry = class.class(KaitaiStruct)

function Lyt.TrackEntry:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root
  self:_read()
...
Lyt.WalkmeshRoomEntry = class.class(KaitaiStruct)

function Lyt.WalkmeshRoomEntry:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root
  self:_read()
...
function Lyt.WalkmeshRoomEntry:_read()
end
