...
class pth_xml_t : public kaitai::kstruct {

public:

    pth_xml_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, pth_xml_t* p__root = 0);
...
public:
    ...
    pth_xml_t* _root() const { return m__root; }
