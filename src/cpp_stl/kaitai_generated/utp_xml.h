...
class utp_xml_t : public kaitai::kstruct {

public:

    utp_xml_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, utp_xml_t* p__root = 0);
...
public:
    ...
    utp_xml_t* _root() const { return m__root; }
