...
class gui_xml_t : public kaitai::kstruct {

public:

    gui_xml_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, gui_xml_t* p__root = 0);
...
public:
    ...
    gui_xml_t* _root() const { return m__root; }
