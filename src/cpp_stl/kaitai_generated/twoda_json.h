#ifndef TWODA_JSON_H_
#define TWODA_JSON_H_
...
class twoda_json_t : public kaitai::kstruct {

public:

    twoda_json_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, twoda_json_t* p__root = 0);
...
public:
    ...
    twoda_json_t* _root() const { return m__root; }
