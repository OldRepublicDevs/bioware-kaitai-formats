...
class are_xml_t : public kaitai::kstruct {

public:

    are_xml_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, are_xml_t* p__root = 0);
...
public:
    ...
    are_xml_t* _root() const { return m__root; }
