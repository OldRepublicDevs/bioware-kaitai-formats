...
class lyt_t : public kaitai::kstruct {

public:
    class artplaceable_entry_t;
    class doorhook_entry_pykotor_t;
    class doorhook_entry_xoreos_t;
    class obstacle_entry_t;
    class room_entry_t;
    class track_entry_t;
    class walkmesh_room_entry_t;

    lyt_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, lyt_t* p__root = 0);
...
public:
    ...
    class artplaceable_entry_t : public kaitai::kstruct {

    public:

        artplaceable_entry_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, lyt_t* p__root = 0);
    ...
    public:
        lyt_t* _root() const { return m__root; }
    ...
    class doorhook_entry_pykotor_t : public kaitai::kstruct {

    public:

        doorhook_entry_pykotor_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, lyt_t* p__root = 0);
    ...
    class doorhook_entry_xoreos_t : public kaitai::kstruct {

    public:

        doorhook_entry_xoreos_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, lyt_t* p__root = 0);
    ...
    class obstacle_entry_t : public kaitai::kstruct {

    public:

        obstacle_entry_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, lyt_t* p__root = 0);
    ...
    class room_entry_t : public kaitai::kstruct {

    public:

        room_entry_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, lyt_t* p__root = 0);
    ...
    class track_entry_t : public kaitai::kstruct {

    public:

        track_entry_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, lyt_t* p__root = 0);
    ...
    class walkmesh_room_entry_t : public kaitai::kstruct {

    public:

        walkmesh_room_entry_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, lyt_t* p__root = 0);
...
public:
     ...
     */
    std::string raw_content() const { return m_raw_content; }
    lyt_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
};
