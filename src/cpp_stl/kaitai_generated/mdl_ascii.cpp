...
#include "mdl_ascii.h"
std::set<mdl_ascii_t::controller_type_common_t> mdl_ascii_t::_build_values_controller_type_common_t() {
    std::set<mdl_ascii_t::controller_type_common_t> _t;
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_COMMON_POSITION);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_COMMON_ORIENTATION);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_COMMON_SCALE);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_COMMON_ALPHA);
    return _t;
}
const std::set<mdl_ascii_t::controller_type_common_t> mdl_ascii_t::_values_controller_type_common_t = mdl_ascii_t::_build_values_controller_type_common_t();
bool mdl_ascii_t::_is_defined_controller_type_common_t(mdl_ascii_t::controller_type_common_t v) {
    return mdl_ascii_t::_values_controller_type_common_t.find(v) != mdl_ascii_t::_values_controller_type_common_t.end();
}
std::set<mdl_ascii_t::controller_type_emitter_t> mdl_ascii_t::_build_values_controller_type_emitter_t() {
    std::set<mdl_ascii_t::controller_type_emitter_t> _t;
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_ALPHA_END);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_ALPHA_START);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_BIRTHRATE);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_BOUNCE_CO);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_COMBINETIME);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_DRAG);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_FPS);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_FRAME_END);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_FRAME_START);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_GRAV);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_LIFE_EXP);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_MASS);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_P2P_BEZIER2);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_P2P_BEZIER3);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_PARTICLE_ROT);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_RANDVEL);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_SIZE_START);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_SIZE_END);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_SIZE_START_Y);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_SIZE_END_Y);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_SPREAD);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_THRESHOLD);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_VELOCITY);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_XSIZE);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_YSIZE);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_BLURLENGTH);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_LIGHTNING_DELAY);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_LIGHTNING_RADIUS);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_LIGHTNING_SCALE);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_LIGHTNING_SUB_DIV);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_LIGHTNINGZIGZAG);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_ALPHA_MID);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_PERCENT_START);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_PERCENT_MID);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_PERCENT_END);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_SIZE_MID);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_SIZE_MID_Y);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_M_F_RANDOM_BIRTH_RATE);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_TARGETSIZE);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_NUMCONTROLPTS);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_CONTROLPTRADIUS);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_CONTROLPTDELAY);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_TANGENTSPREAD);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_TANGENTLENGTH);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_COLOR_MID);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_COLOR_END);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_COLOR_START);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_EMITTER_DETONATE);
    return _t;
}
const std::set<mdl_ascii_t::controller_type_emitter_t> mdl_ascii_t::_values_controller_type_emitter_t = mdl_ascii_t::_build_values_controller_type_emitter_t();
bool mdl_ascii_t::_is_defined_controller_type_emitter_t(mdl_ascii_t::controller_type_emitter_t v) {
    return mdl_ascii_t::_values_controller_type_emitter_t.find(v) != mdl_ascii_t::_values_controller_type_emitter_t.end();
}
std::set<mdl_ascii_t::controller_type_light_t> mdl_ascii_t::_build_values_controller_type_light_t() {
    std::set<mdl_ascii_t::controller_type_light_t> _t;
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_LIGHT_COLOR);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_LIGHT_RADIUS);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_LIGHT_SHADOWRADIUS);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_LIGHT_VERTICALDISPLACEMENT);
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_LIGHT_MULTIPLIER);
    return _t;
}
const std::set<mdl_ascii_t::controller_type_light_t> mdl_ascii_t::_values_controller_type_light_t = mdl_ascii_t::_build_values_controller_type_light_t();
bool mdl_ascii_t::_is_defined_controller_type_light_t(mdl_ascii_t::controller_type_light_t v) {
    return mdl_ascii_t::_values_controller_type_light_t.find(v) != mdl_ascii_t::_values_controller_type_light_t.end();
}
std::set<mdl_ascii_t::controller_type_mesh_t> mdl_ascii_t::_build_values_controller_type_mesh_t() {
    std::set<mdl_ascii_t::controller_type_mesh_t> _t;
    _t.insert(mdl_ascii_t::CONTROLLER_TYPE_MESH_SELFILLUMCOLOR);
    return _t;
}
const std::set<mdl_ascii_t::controller_type_mesh_t> mdl_ascii_t::_values_controller_type_mesh_t = mdl_ascii_t::_build_values_controller_type_mesh_t();
bool mdl_ascii_t::_is_defined_controller_type_mesh_t(mdl_ascii_t::controller_type_mesh_t v) {
    return mdl_ascii_t::_values_controller_type_mesh_t.find(v) != mdl_ascii_t::_values_controller_type_mesh_t.end();
}
std::set<mdl_ascii_t::model_classification_t> mdl_ascii_t::_build_values_model_classification_t() {
    std::set<mdl_ascii_t::model_classification_t> _t;
    _t.insert(mdl_ascii_t::MODEL_CLASSIFICATION_OTHER);
    _t.insert(mdl_ascii_t::MODEL_CLASSIFICATION_EFFECT);
    _t.insert(mdl_ascii_t::MODEL_CLASSIFICATION_TILE);
    _t.insert(mdl_ascii_t::MODEL_CLASSIFICATION_CHARACTER);
    _t.insert(mdl_ascii_t::MODEL_CLASSIFICATION_DOOR);
    _t.insert(mdl_ascii_t::MODEL_CLASSIFICATION_LIGHTSABER);
    _t.insert(mdl_ascii_t::MODEL_CLASSIFICATION_PLACEABLE);
    _t.insert(mdl_ascii_t::MODEL_CLASSIFICATION_FLYER);
    return _t;
}
const std::set<mdl_ascii_t::model_classification_t> mdl_ascii_t::_values_model_classification_t = mdl_ascii_t::_build_values_model_classification_t();
bool mdl_ascii_t::_is_defined_model_classification_t(mdl_ascii_t::model_classification_t v) {
    return mdl_ascii_t::_values_model_classification_t.find(v) != mdl_ascii_t::_values_model_classification_t.end();
}
std::set<mdl_ascii_t::node_type_t> mdl_ascii_t::_build_values_node_type_t() {
    std::set<mdl_ascii_t::node_type_t> _t;
    _t.insert(mdl_ascii_t::NODE_TYPE_DUMMY);
    _t.insert(mdl_ascii_t::NODE_TYPE_LIGHT);
    _t.insert(mdl_ascii_t::NODE_TYPE_EMITTER);
    _t.insert(mdl_ascii_t::NODE_TYPE_REFERENCE);
    _t.insert(mdl_ascii_t::NODE_TYPE_TRIMESH);
    _t.insert(mdl_ascii_t::NODE_TYPE_SKINMESH);
    _t.insert(mdl_ascii_t::NODE_TYPE_ANIMMESH);
    _t.insert(mdl_ascii_t::NODE_TYPE_DANGLYMESH);
    _t.insert(mdl_ascii_t::NODE_TYPE_AABB);
    _t.insert(mdl_ascii_t::NODE_TYPE_LIGHTSABER);
    return _t;
}
const std::set<mdl_ascii_t::node_type_t> mdl_ascii_t::_values_node_type_t = mdl_ascii_t::_build_values_node_type_t();
bool mdl_ascii_t::_is_defined_node_type_t(mdl_ascii_t::node_type_t v) {
    return mdl_ascii_t::_values_node_type_t.find(v) != mdl_ascii_t::_values_node_type_t.end();
}
