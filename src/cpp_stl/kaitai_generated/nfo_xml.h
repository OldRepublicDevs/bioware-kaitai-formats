...
class nfo_xml_t : public kaitai::kstruct {

public:

    nfo_xml_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, nfo_xml_t* p__root = 0);
...
public:
    ...
    nfo_xml_t* _root() const { return m__root; }
