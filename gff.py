...
class Gff(KaitaiStruct):
    ...
    class LocalizedStringData(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Gff.LocalizedStringData, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            for i in range(self.string_count):
                self.substrings.append(Gff.LocalizedSubstring(self._io, self, self._root))
        ...
        def string_ref_value(self):
            ...
            self._m_string_ref_value = self.string_ref
            return getattr(self, '_m_string_ref_value', None)


    class LocalizedSubstring(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Gff.LocalizedSubstring, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
