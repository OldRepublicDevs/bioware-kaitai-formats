meta:
  id: utm
  title: BioWare UTM (Store/Merchant Template) File Format
  license: MIT
  endian: le
  file-extension: utm
  imports:
    - ../../gff
  xref:
    pykotor: https://github.com/OldRepublicDevs/PyKotor/blob/master/Libraries/PyKotor/src/pykotor/resource/generics/utm.py
    reone: https://github.com/seedhartha/reone/blob/master/include/reone/resource/parser/gff/utm.h
...
instances:
  file_type_valid:
    value: gff_data.header.file_type == "UTM "
  version_valid:
    value: |
