...
doc: |
  ...
  References:
  - vendor/PyKotor/wiki/NSS-File-Format.md - Complete NSS format documentation
  - vendor/xoreos-tools/src/nwscript/ - NWScript compiler implementation
  - vendor/reone/src/libs/script/ - Script execution engine (NCS bytecode interpreter)
  - Libraries/PyKotor/src/pykotor/resource/formats/ncs/ - PyKotor NCS/NSS handling
  - vendor/KotOR.js/src/script/ - TypeScript NWScript compiler and runtime
...
seq:
  - id: bom
    ...
    doc: |
      ...
      Valid values: 0xFEFF (UTF-8 BOM) or 0x0000 (no BOM, first character of source code)
